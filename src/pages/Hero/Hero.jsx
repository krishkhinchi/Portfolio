    ...
    <>
      <main className="pt-20 lg:pt-[0rem] bg-[#020617] text-white min-h-screen">
        <section className="hero min-h-screen flex items-center relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0 mt-24">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/krishkhinchi/"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1tF5pXWfyMOoORA9GGCmLX7DQe8oK2Vku/view?usp=sharing"
